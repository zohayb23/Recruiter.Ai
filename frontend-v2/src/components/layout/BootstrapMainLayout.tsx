      ...
      <div id="wrapper">
        ...
        <ul className={`navbar-nav bg-gradient-primary sidebar sidebar-dark accordion ${sidebarToggled ? 'toggled' : ''}`} id="accordionSidebar">
          ...
          <Link className="sidebar-brand d-flex align-items-center justify-content-center" to="/">
            ...
            <div className="sidebar-brand-text mx-3">Recruiter.AI</div>
          </Link>
          ...
          {/* Nav Item - Dashboard */}
          <li className={`nav-item ${isActivePath('/jobs') && !isActivePath('/jobs/external') && !isActivePath('/jobs/description') ? 'active' : ''}`}>
          ...
          <li className={`nav-item ${isActivePath('/jobs/external') ? 'active' : ''}`}>
            <Link className="nav-link" to="/jobs/external">
                ...
                <li className="nav-item dropdown no-arrow">
                  <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    <img className="img-profile rounded-circle"
                      src="/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile.svg" alt="Profile" />
                  </a>
          ...
          <footer className="sticky-footer bg-white">
            <div className="container my-auto">
              <div className="copyright text-center my-auto">
                <span>Copyright © Recruiter.AI 2024</span>
              </div>
            </div>
          </footer>
        </div>
...
export default BootstrapMainLayout; 