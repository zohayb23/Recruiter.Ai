...
class MilvusLoadbalancerService:
    def __init__(self):
        """Initialize the Milvus loadbalancer service"""
        self.host = "localhost"
        self.port = 19532
        self.collection_name = "resumes_lb"
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to connect to Milvus loadbalancer: {e}")
            self.is_connected = False
            return False
    ...
    def init_collection(self):
        ...
        try:
            ...
            schema = CollectionSchema(fields=fields, description="Resume collection for load balancing")
